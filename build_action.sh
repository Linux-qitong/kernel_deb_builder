...
# install dep
cp deepin-app-store-home.gpg /usr/share/keyrings/
cp deepin-archive-camel-keyring.gpg /usr/share/keyrings/
cp deepin-archive-uranus-keyring.gpg /usr/share/keyrings/
